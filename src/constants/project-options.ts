...
export const PROJECT_OPTIONS = [
  ...
  },
  {
    ...
    imageUrl: PHOTO_LIST[1],
    description: 'Utiliza o esporte como ferramenta de inclusão social, através de atividades esportivas. O CDC opta pelo Futsal como modalidade esportiva, por ser um esporte de fácil acesso, e que não exige muitos recursos para sua prática.',
  },
  {
    id: '4',
    title: 'CDC - Centro de desenvolvimento cultural',
    imageUrl: PHOTO_LIST[1],
    description: 'Promove uma melhor interação entre as pessoas, através de atividades culturais, como: dança, teatro, música, artesanato, entre outras.',
  }
]